...
class GraniteResponse(BaseModel):
    ...
    fallback_used: bool = Field(default=False, description="True if Granite failed and fallback was activated")
    ai_engine: str = Field(default="IBM Granite", description="AI engine identifier — always IBM Granite")
