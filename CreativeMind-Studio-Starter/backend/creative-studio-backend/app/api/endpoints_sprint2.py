...
async def submit_follow_up(
    ...
    return ApiResponse(data=FollowUpResponse(user_input=body.user_input, agent_responses=agent_reply))
...
@router.post(
    ...
    response_model=ApiResponse[BoardroomResult],
...
async def refine_idea(
    ...
    return ApiResponse(data=RefineResponse(refined_idea=refined_text, version_number=version_record.version_number))
