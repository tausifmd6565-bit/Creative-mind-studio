...
export const PROJECTS = {
  ...
  stage:  (projectId: ID) => `/projects/${projectId}/stage`,
...
// ─── Boardroom (IBM Granite multi-agent debate) ───────────────────────────────

export const BOARDROOM = {
  run:         (projectId: ID) => `/projects/${projectId}/boardroom`,
  result:      (projectId: ID) => `/projects/${projectId}/boardroom`,
  followUp:    (projectId: ID) => `/projects/${projectId}/follow-up`,
  scorecard:   (projectId: ID) => `/projects/${projectId}/scorecard`,
  pivot:       (projectId: ID) => `/projects/${projectId}/pivot`,
  refine:      (projectId: ID) => `/projects/${projectId}/refine`,
  roadmap:     (projectId: ID) => `/projects/${projectId}/roadmap`,
  report:      (projectId: ID) => `/projects/${projectId}/report`,
} as const;

// ─── Research Lab (IBM Granite — generate + retrieve) ────────────────────────

export const RESEARCH_AI = {
  generate: (projectId: ID) => `/projects/${projectId}/research/generate`,
  get:      (projectId: ID) => `/projects/${projectId}/research`,
} as const;

// ─── Creative Blueprint (IBM Granite — generate + retrieve) ──────────────────

export const BLUEPRINT = {
  generate: (projectId: ID) => `/projects/${projectId}/blueprint/generate`,
  get:      (projectId: ID) => `/projects/${projectId}/blueprint`,
} as const;

// ─── Export ───────────────────────────────────────────────────────────────────

export const EXPORT = {
  json:    (projectId: ID) => `/projects/${projectId}/export/json`,
  pdf:     (projectId: ID) => `/projects/${projectId}/export/pdf`,
  summary: (projectId: ID) => `/projects/${projectId}/export/summary`,
} as const;

// ─── Full AI Pipeline (orchestrated 8-stage workflow) ────────────────────────

export const PIPELINE = {
  /** Run the complete 9-stage IBM Granite pipeline */
  run:    (projectId: ID) => `/projects/${projectId}/pipeline/run`,
  /** Get the latest pipeline result */
  result: (projectId: ID) => `/projects/${projectId}/pipeline/result`,
} as const;
